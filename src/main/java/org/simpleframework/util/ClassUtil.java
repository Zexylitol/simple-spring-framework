...
public class ClassUtil {
    ...
    private static void extractClassFile(Set<Class<?>> emptyClassSet, File fileSource, String packageName) {
        ...
        // 如果 fileSource 是一个文件夹，则调用其 listFiles 方法获取文件夹下的文件或文件夹
        // 过滤出当前目录下的文件夹，class文件直接加载
        File[] files = fileSource.listFiles(new FileFilter() {
            ...
            private void addToClassSet(String absolutePath) {
                ...
                // 如 E:/Java/javaWorkSpace/simple-spring-framework/target/classes/com/uestc/entity/dto/MainPageInfoDTO.java
                // 需转成：com.uestc.entity.dto.MainPageInfoDTO
    ...
    public static void main(String[] args) {
        extractPackageClass("com.uestc.entity");
    }
}
